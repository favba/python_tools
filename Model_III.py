...
pathoutput = './Model_III'

if not os.path.exists(pathoutput): os.makedirs(pathoutput)

index1 = np.memmap('./Model_III/index3',shape=(nx,ny,nz),order='F',dtype = dtype,mode='w+')
alpha = np.memmap('./Model_III/alpha',shape=(nx,ny,nz),order='F',dtype = dtype,mode='w+')
tm11 = np.memmap('./Model_III/Tm11',shape=(nx,ny,nz),order='F',dtype = dtype,mode='w+')
tm12 = np.memmap('./Model_III/Tm12',shape=(nx,ny,nz),order='F',dtype = dtype,mode='w+')
tm13 = np.memmap('./Model_III/Tm13',shape=(nx,ny,nz),order='F',dtype = dtype,mode='w+')
tm22 = np.memmap('./Model_III/Tm22',shape=(nx,ny,nz),order='F',dtype = dtype,mode='w+')
tm23 = np.memmap('./Model_III/Tm23',shape=(nx,ny,nz),order='F',dtype = dtype,mode='w+')
tm33 = np.memmap('./Model_III/Tm33',shape=(nx,ny,nz),order='F',dtype = dtype,mode='w+')
