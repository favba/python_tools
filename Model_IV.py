...
if not os.path.exists('./Model_IV'): os.mkdir('./Model_IV')

index2 = np.memmap('./Model_IV/index4',shape=(nx,ny,nz),order='F',dtype=dtype,mode='w+')
alpha0 = np.memmap('./Model_IV/alpha0',shape=(nx,ny,nz),order='F',dtype=dtype,mode='w+')
alpha1 = np.memmap('./Model_IV/alpha1',shape=(nx,ny,nz),order='F',dtype=dtype,mode='w+')
alpha2 = np.memmap('./Model_IV/alpha2',shape=(nx,ny,nz),order='F',dtype=dtype,mode='w+')

tm11 = np.memmap('./Model_IV/Tm11',shape=(nx,ny,nz),order='F',dtype=dtype,mode='w+')
tm12 = np.memmap('./Model_IV/Tm12',shape=(nx,ny,nz),order='F',dtype=dtype,mode='w+')
tm13 = np.memmap('./Model_IV/Tm13',shape=(nx,ny,nz),order='F',dtype=dtype,mode='w+')
tm22 = np.memmap('./Model_IV/Tm22',shape=(nx,ny,nz),order='F',dtype=dtype,mode='w+')
tm23 = np.memmap('./Model_IV/Tm23',shape=(nx,ny,nz),order='F',dtype=dtype,mode='w+')
tm33 = np.memmap('./Model_IV/Tm33',shape=(nx,ny,nz),order='F',dtype=dtype,mode='w+')
